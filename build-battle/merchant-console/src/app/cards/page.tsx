      ...
      <div className="flex flex-col justify-between gap-2 px-4 py-6 sm:flex-row sm:items-center sm:p-6">
        <div>
          ...
          <p className="text-sm text-gray-500">
            {cards.length === 0
              ? "Issue a card for a merchant's vendor subscriptions, ad spend, or contractor tools."
              : `${cards.length.toLocaleString()} ${cards.length === 1 ? "card" : "cards"} issued`}
          </p>
        </div>
        <IssueCardDialog
              ...
              <TableRow>
                <TableCell colSpan={7} className="py-16 text-center">
                  ...
                  <p className="mx-auto mt-1 max-w-md text-gray-500">
                    Ops used to request these from the platform team by hand.
                    Issue the first one and it will appear here straight away.
                  </p>
                </TableCell>
              </TableRow>
            )}
                ...
                <TableRow key={card.id}>
                  ...
                  <TableCell>
                    <div className="flex justify-end">
                      <CardActions id={card.id} status={card.status} compact />
                    </div>
                  </TableCell>
                </TableRow>
              )
